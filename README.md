...
![전투](https://github.com/user-attachments/assets/0b51fb52-0c78-427d-9e03-d00621ad3dca)
...
서버에서는 모든 유닛들의 반지름 크기를 기준으로 그 둘레를 채우는 좌표들을 가지고, 이동 및 정지 시 이 좌표들을 갱신한다. 서버에서는 콜라이더 집합이라 표현하며, 이 콜라이더 집합을 토대로 유닛의 제자리 걸음을 판정하고, JPS 알고리즘의 설정 값으로 활용한다. 
